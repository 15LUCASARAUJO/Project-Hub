...
## Prerequisites
All you need is programming software.
...
O **Hub de Projetos** foi pensado para suprir a necessidade de registrar os projetos possoais, com visualização de progresso para atualizações em tempo real, para um controle melhor do portifólio pessoal.
>**Por que este projeto?**  
>Ter uma gestão e controle de projetos é fundamental para organização e aprimoramento de habilidades.
...
## Pré-requisitos
Apenas necessário um software de programação.

---

## Configuração

Não há configurações avançadas.
